           ...
           // String publishday = request.getParameter("publishday");
            ...
            switch (action) {
                case "add":
                    ...
                    Product sp;
            sp = new Product(Integer.parseInt(id), name, Integer.parseInt(quantity), (int) Double.parseDouble(price), new Category(idDanhMuc, ""));
                    ...
                    if (spDao.addSanPham(sp) == 1) {
                        ...
                        request.getRequestDispatcher("/admin/mkhachhang.jsp").forward(request, response);
                    }
                ...
                case "update":
                    //out.print("mmm");
                    Product pr=new Product(Integer.parseInt(id), name, Integer.parseInt(quantity), (int) Double.parseDouble(price), new Category(idDanhMuc, ""));
